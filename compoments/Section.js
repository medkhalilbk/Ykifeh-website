  ...
  return (
    <div className='text-1' style={{textAlign:'center'  , marginTop:'2%' }} >
     ...
     data-aos-duration="3000" style={{ position: 'relative', height: 600 }}>
      ...
      <img src="emojis.png" alt="Emojis" style={{ height:'100%', position: 'absolute' ,top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }} />
    </div>
    ...
    <div data-aos="zoom-in" style={{ position: 'relative', height: 600 , marginTop:150 }}>
      ...
      <Text  fontSize={'2xl'} fontWeight={200} margin={"auto"} width={'30%'} marginTop={'-140'}  zIndex={0} align={'center'}> 
      Corem ipsum dolor sit 
    </Text>
      <Text  fontSize={'4xl'} fontWeight={900} margin={"auto"} width={'30%'} marginTop={''}  zIndex={2} align={'center'}> 
